...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='https://t.me/Animemusicarchive6'),
        InlineKeyboardButton('Our group', url='https://t.me/Yeageristbots')
    ]]
...
Made With Love By Team @Animemusicarchive6</b>""",
